...
public class easyLevels2 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        Image image1 = imageIcon1.getImage().getScaledInstance(250, 250, Image.SCALE_SMOOTH);
    ...
    private void checkAnswers(JFrame gameFrame) {
        ...
        if (enteredAnswer1.equals(correctAnswer1) &&
            ...
            JOptionPane.showMessageDialog(gameFrame, "All answers are correct!");
            gameFrame.dispose();
            openNextLevel();
        } else {
            JOptionPane.showMessageDialog(gameFrame, "One or more answers are incorrect!");
        }
