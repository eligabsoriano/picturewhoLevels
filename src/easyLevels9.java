...
public class easyLevels9 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/dogfan.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/fanface.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/manyfans.jpeg");
        ImageIcon imageIcon4 = new ImageIcon("img/fans.jpeg");
    ...
    private void checkAnswers(JFrame gameFrame) {
        ...
        // Replace these with the correct answers for each box
