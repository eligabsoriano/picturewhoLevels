...
public class easylevels7 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/foot-800x800.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/Signing-Pen-1-scaled.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/brendan-church-pKeF6Tt3c08-unsplash.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/istockphoto-1072359684-612x612.jpg");
        ...
        submitButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String correctAnswer = "sign"; // Replace with your actual answer
