...
public class hardlevel1 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/bike.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/lockbike.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/bikefall.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/bikeseat.jpg");
        ...
        answerField7 = createSingleLetterTextField(gameFrame, null);
    ...
    private void checkAnswers(JFrame gameFrame) {
        ...
        String correctAnswer4 = "y";
        String correctAnswer5 = "c";
        String correctAnswer6 = "l";
