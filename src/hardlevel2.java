...
public class hardlevel2 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/decorate.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/decoratememe.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/soldierdecorate.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/cakedecorate.jpg");
    ...
    private void checkAnswers(JFrame gameFrame) {
        ...
        String correctAnswer4 = "o";
        String correctAnswer5 = "r";
        String correctAnswer6 = "a";
        String correctAnswer7 = "t";
