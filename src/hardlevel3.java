...
public class hardlevel3 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/disguise.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/soldierdisguise.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/disguisepokemon.png");
        ImageIcon imageIcon4 = new ImageIcon("img/dogdisguise.jpg");
    ...
    private void checkAnswers(JFrame gameFrame) {
        ...
        String correctAnswer4 = "g";
        String correctAnswer5 = "u";
        String correctAnswer6 = "i";
        String correctAnswer7 = "s";
        String correctAnswer8 = "e";
