...
public class hardlevel4 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/sinsiter.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/sinistermarvel.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/creepsinister.png");
        ImageIcon imageIcon4 = new ImageIcon("img/evil-patrick.jpg");
