...
public class hardlevel6 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/gradient.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/gradientmath.png");
        ImageIcon imageIcon3 = new ImageIcon("img/gradientroad.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/calcugradient.png");
