...
public class hardlevel7 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/boundary.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/wallboundary.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/greatwallsofchina.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/frameboundary.jpg");
    ...
    private void checkAnswers(JFrame gameFrame) {
        ...
        String correctAnswer3 = "u";
        String correctAnswer4 = "n";
        String correctAnswer5 = "d";
        String correctAnswer6 = "a";
        String correctAnswer7 = "r";
        String correctAnswer8 = "y";
