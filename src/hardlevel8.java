...
public class hardlevel8 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/parmesan.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/baked-chicken-parmesan-1.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/parmesancheese.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/rissotoparmean.jpg");
    ...
    private void checkAnswers(JFrame gameFrame) {
        ...
        String correctAnswer4 = "m";
        String correctAnswer5 = "e";
        String correctAnswer6 = "s";
        String correctAnswer7 = "a";
        String correctAnswer8 = "n";
