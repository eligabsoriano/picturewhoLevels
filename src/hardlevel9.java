...
public class hardlevel9 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/crossbarbike.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/crossbarsoccer.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/crossbarchallenge.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/handlecrossbar.jpg");
