...
public class moderatelevel1 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/classic-pick-and-mix.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/iStock_49885466_4x3.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/iStock-619961796-edit-59cabaf6845b3400111119b7.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/images.jpg");
    ...
    private void checkAnswers(JFrame gameFrame) {
        ...
        String correctAnswer2 = "w";
        String correctAnswer3 = "e";
        String correctAnswer4 = "e";
        String correctAnswer5 = "t";
