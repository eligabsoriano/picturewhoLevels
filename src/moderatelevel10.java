    ...
    private void openGameWindow() {
        ...
        submitButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String correctAnswer = "energy"; // Replace with your actual answer

                if (enteredAnswer.equals(correctAnswer)) {
                    JOptionPane.showMessageDialog(gameFrame, "Congratulations! You've completed the Moderate mode. Ready for the next challenge?");
