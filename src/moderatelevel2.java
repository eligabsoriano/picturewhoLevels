...
public class moderatelevel2 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/fatherbaby.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/fathers-day-quotes-share-w-dad-01-1440x810.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/Fathers-in-South-Africa-2.png");
        ImageIcon imageIcon4 = new ImageIcon("img/fatherdance.jpg");
    ...
    private void checkAnswers(JFrame gameFrame) {
        ...
        String correctAnswer1 = "f";
        String correctAnswer2 = "a";
        String correctAnswer3 = "t";
        String correctAnswer4 = "h";
        String correctAnswer5 = "e";
        String correctAnswer6 = "r";
