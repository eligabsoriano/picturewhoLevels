...
public class moderatelevel3 implements ActionListener {
    private JButton submitButton;
    @SuppressWarnings("unused")
    private int currentLevel = 1;

    public moderatelevel3() {
        openGameWindow();
    }
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/hiphop.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/yaa-hiphop-1024x683.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/drake.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/jaquel-knight-hip-hop-1024x683.jpeg");
