...
public class moderatelevel5 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/bitter.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/bittermeme.jpeg");
        ImageIcon imageIcon3 = new ImageIcon("img/bittercoffee.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/ampalaya.jpg");
