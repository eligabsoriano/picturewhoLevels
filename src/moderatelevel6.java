...
public class moderatelevel6 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/best-places-like-france.jpeg");
        ImageIcon imageIcon2 = new ImageIcon("img/france.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/francedog.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/failfrance.jpg");
    ...
    private void checkAnswers(JFrame gameFrame) {
        ...
        String correctAnswer4 = "n";
        String correctAnswer5 = "c";
        String correctAnswer6 = "e";
