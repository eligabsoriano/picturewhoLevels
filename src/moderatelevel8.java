...
public class moderatelevel8 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/bubble.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/chatbubble.png");
        ImageIcon imageIcon3 = new ImageIcon("img/nbabubble.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/Chubby-Bubbles-Girl.jpg");
