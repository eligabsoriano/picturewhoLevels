...
public class moderatelevel9 implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("img/piratetreasure.jpg");
        ImageIcon imageIcon2 = new ImageIcon("img/cannon.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/parrot.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/luffy.jpg");
